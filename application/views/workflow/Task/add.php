...
<div class="row">
    <div class="col-md-6" style="height:150px">
        <input type="text" class="form-control" id="taskname" name="taskname" value="" placeholder="任务名称"><br />
        <input type="text" class="form-control" id="explain" name="explain" value="" placeholder="任务说明"><br />
        <input type="text" class="form-control" id="priority" name="priority" value="" placeholder="优先级，请输入正整数，数值越大优先级越高">
    </div>
...
$(document).ready(function(){
  ...
  workflow.onBtnSaveClick=function(){
      ...
      var url = '/workflow/task/add';
      var postData = {fid:fid,name:taskname,explain:$("#explain").val(),priority:$("#priority").val(),flow:JSON.stringify(jsondata)};
      $.post(url, postData,
          function(data){
