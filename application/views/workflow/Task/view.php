    ...
    <section class="col-md-6">
      <div class="box box-info">
        <div class="box-header">
          <h3 class="box-title">当前节点: <?php echo str_replace('<hr>', ' | ', $current['name']);?>
</h3>
</div>
        ...
        <div class="form-group">
            ...
            <label class="">
                <div class="iradio_minimal-red" aria-checked="false" aria-disabled="false" style="position: relative;">
                    <input type="radio" value="<?php echo $value;?>" name="r2" class="minimal-red"
...
<section class="col-md-6">
    <div class="box box-success">
        <div class="box-header">
            <h3 class="box-title">操作记录
                <?php echo $listData ? '<span style="color:#ff8800;padding-left:15px;font-size:12px;">总耗时:'.getConsume(strtotime($listData[0]->create_time), strtotime(end($listData)->create_time)).'</span>' : '';?>
            </h3>
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <?php echo in_array($val->operate, array(0,3)) ? '系统' : $val->username; ?>
                                    </td>
                                    <td>
                                        <?php echo $val->create_time; ?>
                                        <br />
                                        <?php echo $key<count($listData)-1 ? '<span style="color:#ff8800;">耗时:'.getConsume(strtotime($val->create_time), strtotime($listData[$key+1]->create_time)).'</span>' : ''; ?>
                                    </td>
                                    <td>
                                        <?php 
