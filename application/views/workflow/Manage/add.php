...
<div class="row">
    <div class="col-md-6" style="height:90px">
        <input type="text" class="form-control" id="flowname" name="flowname" value="<?php echo $flowInfo ? $flowInfo->name : ''; ?>"
            placeholder="工流程名称">
        <br />
        <input type="text" class="form-control" id="explain" name="explain" value="<?php echo $flowInfo ? $flowInfo->explain : ''; ?>"
            placeholder="工流程说明">
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="text" class="form-control" name="node_name" id="node_name" value="" placeholder="节点名称">
                <br/>
                <label>相关人员</label>
    ...
    $(document).ready(function() {
        ...
        workflow.onBtnSaveClick = function() {
            ...
            var postData = {
                ...
                name: flowname,
                explain: $("#explain").val(),
                flow: JSON.stringify(workflow.exportData())
            };
            $.post(url, postData,
                function(data) {
