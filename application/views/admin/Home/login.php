  ...
  <div class="login-box-body">
    ...
    <form action="/admin/home/login" method="post">
      <div class="form-group has-feedback">
        <input type="text" name="username" value="<?php echo isset($username) ? $username : ''; ?>" class="form-control" id="inputWarning"
      ...
      <div class="form-group has-feedback">
        ...
        <span style="width:200px;float:right">
          <?php $this->widget('DyCaptchaWidget', array('request'=>DyRequest::createUrl('/admin/home/captcha', array('ct'=>'adminlogin')),'buttonLabel'=>'看不清')); ?>
        </span>
      </div>
      <div class="row">
