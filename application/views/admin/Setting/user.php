              ...
              <table class="table table-hover">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <?php echo $val->status == 1 ? '<span class="label label-success">正常</span>' : '<span class="label label-danger">禁用</span>'; ?>
                      <?php echo $val->pw_err_num >= 3 ? '<hr style="width:35px;" /><span class="label label-warning">锁定</span>' : ''; ?>
                    </td>
                    <td align="right">
                      <?php if ($val->id > 1):?>
